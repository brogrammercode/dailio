...
class _MemberDetailPageState extends State<MemberDetailPage> {
  ...
  Future<void> _loadMember() async {
    ...
    try {
      final result =
          await _repository.getMember(_locationId, widget.membershipId);
  ...
  Future<void> _performAction(String action) async {
    ...
    if (confirmed == true) {
      ...
      try {
        if (action == 'suspend') {
          await _repository.suspendMember(
              _locationId, widget.membershipId, reasonController.text.trim());
        } else {
                  ...
                  : SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              '${_member!.fullName} (${_member!.membershipNumber})',
                          ...
                          const SizedBox(height: 8),
                          if (_member!.role != null)
                            ListTile(
                                title: Text(_member!.role!.name),
                                leading: const Icon(Iconsax.award)),
